-- Corrección al cambio anterior (20260821060000): "comisión" en el
-- desglose por empleado no debe filtrar por cut_id en absoluto — el
-- usuario aclaró que ahí va lo que el empleado GANÓ de comisión por
-- los servicios de ESE periodo (mismo rango de fechas que ingresos),
-- sin importar si ya se liquidó/pagó o sigue pendiente. Filtrar por
-- cut_id is not null dejaba en $0 a cualquier empleado cuyas
-- comisiones de ese periodo no se hubieran procesado todavía en
-- Comisiones, que es el caso normal (son dos acciones independientes,
-- ver 20260821060000 y la conversación con el usuario sobre no
-- fusionarlas).
